    ...
    const navlinks = <>
        <li className='mr-4'><NavLink to='/'
            className={({ isActive, isPending }) =>
                isPending ? "pending" : isActive ? "md:pb-2 text-white font-bold border-b-2" : "text-white"
            }
        >Home</NavLink></li>
        ...
        <li className='mr-4'><NavLink to='/register'
            className={({ isActive, isPending }) =>
                isPending ? "pending" : isActive ? "md:pb-2 text-white font-bold underline md:border-b-2" : "text-white"
            }
        >Register</NavLink></li>
    </>
